...
from .views import login,InicioPaciente,enviar_cliente_a_api,enviar_correo,disponibilidad,loginMedico,CDPrueba,HoraMedica,HoraDisponible,verPacientes,vistaMedico,agenda,agregaragenda
