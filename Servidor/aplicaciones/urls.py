...
from .views import enviar_correo, login,InicioPaciente,enviar_cliente_a_api,disponibilidad,loginMedico,CDPrueba,HoraMedica,HoraDisponible,verPacientes,vistaMedico,agenda,agregaragenda
